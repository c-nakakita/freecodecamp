...
--
-- Name: elements elements_unique_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_unique_name UNIQUE (name);


--
-- Name: elements elements_unique_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_unique_symbol UNIQUE (symbol);
